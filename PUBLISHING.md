...
- Prepare final icons, screenshots of the real app, description, support/privacy URLs and review instructions. Supply working review accounts and explain that accepting a letter opens chat and delivery takes time. Configure and test calls and native push before advertising them; follow [COMMUNICATIONS.md](COMMUNICATIONS.md). Calls currently require the app to remain in the foreground. Online multiplayer is not implemented.
